<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detailmatch.aspx.cs" Inherits="WebApplication19.detailmatch" %>
...
<body>
    ...
    <div style="height: 470px; width: 1240px">
        ...
        <br />
        <br />
        <asp:Label ID="Label3" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 23px; margin-top: 0px; margin-bottom: 0px" Text="ID_Match" Width="30px"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label5" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 21px; margin-top: 0px; margin-bottom: 0px" Text="Result" Width="101px"></asp:Label>
        ...
        <br />
&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label4" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 0px; margin-top: 0px; margin-bottom: 0px" Text="Team_ID_won" Width="48px"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000048" Text="Team_ID_lost"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000066" Text="point judgment"></asp:Label>
&nbsp;
...
&nbsp;&nbsp;
        ...
        &nbsp;<asp:CheckBox ID="CheckBox7" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox7_CheckedChanged" Text="information of team by team_ID" />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox8" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox8_CheckedChanged" Text="information of  match by ID match" />
&nbsp;
        <br />
&nbsp;<asp:CheckBox ID="CheckBox12" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" OnCheckedChanged="CheckBox10_CheckedChanged" Text="information of referee this match by ID_match" />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox10" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox10_CheckedChanged" Text="information of season by id_season" />
&nbsp;&nbsp;
        <br />
