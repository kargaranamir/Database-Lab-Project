<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Referee.aspx.cs" Inherits="WebApplication19.Referee" %>
...
&nbsp;
        <br />
&nbsp;
        <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000066" Text="Date Start Referee"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000066" Text="Level Referee"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox1" runat="server" OnCheckedChanged="CheckBox1_CheckedChanged" Text="A" />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox2" runat="server" OnCheckedChanged="CheckBox2_CheckedChanged" Text="B" />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox3" runat="server" OnCheckedChanged="CheckBox3_CheckedChanged" Text="C" />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox4" runat="server" OnCheckedChanged="CheckBox4_CheckedChanged" Text="D" />
        <br />
&nbsp;
        <br />
&nbsp;
        <br />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox5" runat="server" Font-Bold="True" Font-Names="Arial" Text="Referee" />
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox6" runat="server" Font-Bold="True" Font-Names="Arial" Text="Assist Referee" />
        <br />
        <br />
...
&nbsp;&nbsp;
        ...
        &nbsp;<asp:CheckBox ID="CheckBox7" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox7_CheckedChanged" Text="ID" />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox8" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox8_CheckedChanged" Text="Name" />
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox9" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox9_CheckedChanged" Text="Last Name" />
        <br />
