<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="season.aspx.cs" Inherits="WebApplication19.season1" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label5" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 21px; margin-top: 0px; margin-bottom: 0px" Text="Category" Width="101px"></asp:Label>
        <asp:CheckBox ID="CheckBox1" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox1_CheckedChanged1" Text="Premier League" />
&nbsp;
        <asp:CheckBox ID="CheckBox2" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox2_CheckedChanged1" Text="League 1" />
&nbsp;
        <asp:CheckBox ID="CheckBox3" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox3_CheckedChanged1" Text="League 2" />
&nbsp;
        <asp:CheckBox ID="CheckBox4" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox4_CheckedChanged1" Text="League 3" />
        <br />
        <br />
&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label4" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 0px; margin-top: 0px; margin-bottom: 0px" Text="Date start" Width="85px"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000048" Text="Date End"></asp:Label>
...
&nbsp;&nbsp;
        <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Names="Arial" Text="Search by season_id"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
