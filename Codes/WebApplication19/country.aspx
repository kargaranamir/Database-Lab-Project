<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="country.aspx.cs" Inherits="WebApplication19.WebForm1" %>
...
<body>
    ...
    <div style="height: 470px; width: 1240px">
        ...
        <br />
&nbsp;&nbsp;
        <asp:Label ID="Label2" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 18px; margin-top: 0px; margin-bottom: 0px" Text="ID" Width="36px"></asp:Label>
        <asp:TextBox ID="TextBox1" runat="server" BackColor="White" BorderColor="#00004A" ForeColor="#000066" OnTextChanged="TextBox1_TextChanged1" style="margin-left: 0px" Width="134px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button17" runat="server" BackColor="#000035" BorderColor="White" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="Medium" ForeColor="White" Height="27px" OnClick="Button1_Click1" style="margin-left: 0px" Text="INSERT" Width="152px" />
        <br />
        <br />
&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label3" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 4px; margin-top: 0px; margin-bottom: 0px" Text="Name" Width="48px"></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server" BackColor="White" BorderColor="#000042" ForeColor="#000066" Height="16px" OnTextChanged="TextBox2_TextChanged" style="margin-left: 0px; margin-bottom: 0px" Width="133px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button18" runat="server" BackColor="#000035" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="Medium" ForeColor="White" Height="28px" OnClick="Button4_Click" style="margin-left: 5px; margin-bottom: 0px" Text="Edit" Width="149px" />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button19" runat="server" BackColor="#000033" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="Medium" ForeColor="White" Height="29px" OnClick="Button3_Click" style="margin-left: 98px" Text="Delete" Width="146px" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        <br />
&nbsp;&nbsp;
...
&nbsp;<asp:ImageButton ID="ImageButton4" runat="server" Height="16px" ImageUrl="http://dopro.ir/blog/wp-content/uploads/2017/03/1-ZimH1QT0zKfzzgocMfpYOA-2.png" OnClick="ImageButton4_Click" style="margin-left: 5px" Width="26px" />
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Arial" Text="Search by ID Country"></asp:Label>
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#000066" BorderStyle="Double" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="Small" ForeColor="#000066" Height="53px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="margin-left: 27px; margin-top: 0px" Width="16px">
        </asp:GridView>
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
