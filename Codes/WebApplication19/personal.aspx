<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="personal.aspx.cs" Inherits="WebApplication19.personal" %>
...
&nbsp;
        <br />
&nbsp;
        <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000066" Text="Date Start Working"></asp:Label>
        ...
        <br />
&nbsp;
        <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000066" Text="Titel"></asp:Label>
        <asp:TextBox ID="TextBox9" runat="server" BorderColor="#000066" OnTextChanged="TextBox9_TextChanged" style="margin-left: 120px"></asp:TextBox>
        <br />
        <br />
        <br />
