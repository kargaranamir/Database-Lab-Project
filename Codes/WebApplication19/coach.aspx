<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="coach.aspx.cs" Inherits="WebApplication19.coach1" %>
...
&nbsp;
        <br />
&nbsp;
        <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000066" Text="Date Start Coaching"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="#000066" Text="Level Coach "></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;
        <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Names="Arial" Text="Search by ID Coach"></asp:Label>
        <br />
