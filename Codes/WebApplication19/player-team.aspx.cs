...
{
    public partial class player_team : System.Web.UI.Page
    {
        ...
        public void BindGridView()
        {
            ...
            var result = from f in db.players join S in db.team_players on  f.player_id equals S.id_player join p in db.teams on S.id_team equals p.team_id 
                         select new
                         {S.id_player,
                            f.player_name,
                            f.player_lastname,
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var goal = (from S in dbCount.team_players
                            where S.id_season == Convert.ToInt32(TextBox1.Text) && S.id_player == Convert.ToInt32(TextBox2.Text)
                ...
                using (DataClasses1DataContext dbCount = new DataClasses1DataContext())
                {
                    try
                    {
                     ...
                     && S.id_team == Convert.ToInt32(TextBox3.Text)
                                    ...
                                    select S).Single();
                        dbCount.team_players.DeleteOnSubmit(goal);
                        dbCount.SubmitChanges();
