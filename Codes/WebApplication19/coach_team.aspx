<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="coach_team.aspx.cs" Inherits="WebApplication19.coach_team" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label5" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000046" style="margin-left: 21px; margin-top: 0px; margin-bottom: 0px" Text="ID-Coach" Width="101px"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox8" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox8_CheckedChanged" Text="coach by name" />
&nbsp;&nbsp;
...
&nbsp;
        <asp:CheckBox ID="CheckBox9" runat="server" Font-Bold="True" Font-Names="Arial" OnCheckedChanged="CheckBox9_CheckedChanged" Text="coach by id" />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
