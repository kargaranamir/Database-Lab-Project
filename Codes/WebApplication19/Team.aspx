<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Team.aspx.cs" Inherits="WebApplication19.Team" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:Label ID="Label5" runat="server" BackColor="White" BorderColor="White" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Small" ForeColor="#000046" style="margin-left: 21px; margin-top: 0px; margin-bottom: 0px" Text="ID-City" Width="101px"></asp:Label>
...
&nbsp;&nbsp;
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Arial" Text="Search by team ID "></asp:Label>
        <br />
        <asp:GridView ID="GridView1" runat="server" BorderColor="#000128" BorderStyle="Double" Font-Size="Small" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        </asp:GridView>
        <br />
&nbsp;&nbsp;
